                        ...
                        <form action="{{ url()->current() }}" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="authorization_name" class="form-control" placeholder="Enter username"
                                        required />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="authorization_type" id="" class="form-control">
                                        ...
                                        <option value="0">Yang Menyetujui</option>
                                        <option value="1">Yang Membuat</option>
                                    </select>
