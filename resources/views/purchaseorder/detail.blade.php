        ...
        <div class="row">
            <div class="col-8">
                <div class="form-group row">
                    <label for="inputPoId" class="col-2 col-form-label">Purchase Order ID :</label>
                    <div class="col">
                        {{ $po->po_id ?? '' }}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPoId" class="col-2 col-form-label">Supplier Name :</label>
                    <div class="col">
                        {{ $po->sup_name ?? '' }}
                    </div>
                </div>
            ...
            <div class="col-4">
                <div class="form-group row">
                    ...
                    <div class="col">
                        {{ !empty($po) ? date('Y-m-d', strtotime($po->date)) : '' }}
                    </div>
                </div>
            </div>
        </div>
